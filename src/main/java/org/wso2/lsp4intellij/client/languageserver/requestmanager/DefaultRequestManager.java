...
public class DefaultRequestManager implements RequestManager {
    ...
    public CompletableFuture<Hover> hover(TextDocumentPositionParams params) {
        if (checkStatus()) {
            try {
                Boolean supportHoverProvider = serverCapabilities.getHoverProvider();
                return (supportHoverProvider != null && supportHoverProvider) ? textDocumentService.hover(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
    ...
    public CompletableFuture<List<? extends Location>> references(ReferenceParams params) {
        if (checkStatus()) {
            try {
                Boolean supportReferencesProvider = serverCapabilities.getReferencesProvider();
                return (supportReferencesProvider != null && supportReferencesProvider) ? textDocumentService.references(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
    ...
    public CompletableFuture<List<? extends DocumentHighlight>> documentHighlight(TextDocumentPositionParams params) {
        if (checkStatus()) {
            try {
                Boolean supportDocumentHighlightProvider = serverCapabilities.getDocumentHighlightProvider();
                return (supportDocumentHighlightProvider != null && supportDocumentHighlightProvider) ? textDocumentService.documentHighlight(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
    ...
    public CompletableFuture<List<Either<SymbolInformation, DocumentSymbol>>> documentSymbol(DocumentSymbolParams params) {
        if (checkStatus()) {
            try {
                Boolean supportDocumentSymbolProvider = serverCapabilities.getDocumentSymbolProvider();
                return (supportDocumentSymbolProvider != null && supportDocumentSymbolProvider) ? textDocumentService.documentSymbol(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
    ...
    public CompletableFuture<List<? extends TextEdit>> formatting(DocumentFormattingParams params) {
        if (checkStatus()) {
            try {
                Boolean supportDocumentFormattingProvider = serverCapabilities.getDocumentFormattingProvider();
                return (supportDocumentFormattingProvider != null && supportDocumentFormattingProvider) ? textDocumentService.formatting(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
    ...
    public CompletableFuture<Either<List<? extends Location>, List<? extends LocationLink>>> definition(TextDocumentPositionParams params) {
        if (checkStatus()) {
            try {
                Boolean supportDefinitionProvider = serverCapabilities.getDefinitionProvider();
                return (supportDefinitionProvider != null && supportDefinitionProvider) ? textDocumentService.definition(params) : null;
            } catch (Exception e) {
                crashed(e);
                return null;
            }
